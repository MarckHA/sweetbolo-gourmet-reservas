...
const Index = () => {
  ...
  const handleConfirm = () => {
    ...
    useEffect(() => {
      const checkAvailability = () => {
        ...
        const offHoursDate = new Date(2026, 5, 8, 23, 59, 0); 
        if (now >= offHoursDate) {
      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-md space-y-6 animate-fade-up">
          ...
          <p className="text-muted-foreground text-lg">
            Las reservas para la fecha 08/06/2026 han finalizado. 
            Próxima apertura de reservas el 11/06/2026. 
  ...
  return (
    ...
    <div className="bg-accent/15 border-b border-accent/20 py-2 px-4 backdrop-blur-md">
        ...
        <span className="font-bold text-accent">Importante:</span> Pedidos abiertos hasta las 23:59 hrs del 08/06/26. 
        Entregas mañana 09/06/26 a partir de las 13:00 hrs. 
        </p>
    </div>
    </div>
