  ...
  const handleConfirm = () => {
    ...
    useEffect(() => {
      const checkAvailability = () => {
        ...
        const offHoursDate = new Date(2026, 7, 20, 23, 59, 0); 
        if (now >= offHoursDate) {
      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-md space-y-6 animate-fade-up">
          ...
          <p className="text-muted-foreground text-lg">
            Las reservas para la fecha 21/08/2026 han finalizado. 
            Próxima apertura de reservas será el 24/08/2026. 
...
>
  ...
  return (
    ...
    <div className="bg-accent/15 border-b border-accent/20 py-2 px-4 backdrop-blur-md">
        ...
        <span className="font-bold text-accent">Importante:</span> Pedidos abiertos hasta las 23:59 del 20/08/26. 
        Entregas el día 21/08/26 a partir de las 09:00. 
        </p>
    </div>
    </div>
